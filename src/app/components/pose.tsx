...
export default function Pose() {
  return (
    <div className="w-full h-full mt-8 sm:mt-0 sm:h-[700px] bg-[#F2F0F1] flex-col flex justify-start items-center max-w-screen-2xl mx-auto">
        {/* top div */}
        <div className="mt-2">
        ...
        <div className=" w-[90%] h-full sm:h-[600px] mt-5 flex flex-wrap justify-center items-center pt-8">
         ...
         <div className="w-[600px] h-[250px] mt-1 md:ml-8 relative">
         ...
         <div className="w-[650px] h-[250px] mt-1 relative">
         <Image src={"/pose2.svg"}  className= " w-full h-full rounded-[20px]" width={100} height={100} alt="pose3"></Image>
         <span className="absolute top-10 left-10 md:left-20 font-bold text-xl">Party</span>
         </div>

         <div className="w-[450px] h-[250px] mt-1 mr-0 md:mr-6 relative">
         <Image src={"/pose4.svg"}   className=" w-full h-full rounded-[20px]" width={100} height={100} alt="pose4"></Image>
         <span className="absolute top-10 left-10 md:left-20 font-bold text-xl">Gym</span>
         </div>
